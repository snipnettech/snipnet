                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-sm-4 text-right m-b-30">
							<a href="create-estimate.html" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Create New Estimate</a>
						</div>
					</div>
								...
								<table class="table table-striped custom-table m-b-0">
									...
									<tbody>
										<tr>
											...
											<td>7 Sep 2017</td>
											<td>$2099</td>
											<td><span class="label label-success-border">Accepted</span></td>
											<td class="text-right">
												<div class="dropdown">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu pull-right">
														<li><a href="edit-estimate.html"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
										...
										<tr>
											...
											<td>7 Sep 2017</td>
											<td>$2099</td>
											<td><span class="label label-danger-border">Declined</span></td>
											<td class="text-right">
												<div class="dropdown">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu pull-right">
										...
										<tr>
											...
											<td>7 Sep 2017</td>
											<td>$2099</td>
											<td><span class="label label-warning-border">Expired</span></td>
											<td class="text-right">
												<div class="dropdown">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu pull-right">
